    ...
    <Card class="p-col-12 p-md-8 p-shadow-12">
      ...
      <template #content>
        <Accordion :activeIndex="0" :multiple="true">
          <AccordionTab>
            ...
            <p>
              Selleks, et saaksime aimu ürituse formaadist, ülesannete
              keerukusest ja keskkonna sobivusest, koostasime väikese tagasiside
              vormi. Loodame, et leiate mõne minuti aega, et see ära täita. See
              ei ole kohustuslik ja ei mõjuta mingil määral teie lõpptulemust.
              Vormi täitmine võtab aega 5 kuni 10 minutit ning on anonüümne.
              Sellelt lehelt lahkudes enam tagasisidet esitada ei saa.
            </p>
            <br />
            <p>
              Tuletame siinkohal meelde, et kõik salvestused tuleb hoida alles
              14 päeva alates tänasest. Võitjatega võetakse ühendust emaili teel
              ning palutakse edastada salvestuste link. Edasi toimub parimate
              lahenduste kontrollimine ja võitjate kinnitamine. Esialgsed
              tulemused on nähtaval juba praegu, kuid lõpptulemus võib muutuda
              vastavalt võistluse statuudile. Parimad osalejad selguvad 14 päeva
              jooksul ja need kajastakse DeltaSprindi avalehel ning Mitsi
              Facebookis.
            </p>
          </AccordionTab>
          ...
          <AccordionTab>
            ...
            <div class="p-fluid">
              ...
              <p>
                Kui tõenäoline on, et osaleksite veel DeltaSprindil või
                soovitaksite seda sõbrale?
              </p>
          ...
          <AccordionTab>
            ...
            <div class="p-fluid">
              ...
              <p>
                Milliseid tööriistu/vahendeid te ülesannete lahendamisel
                kasutasite?
              </p>
          ...
          <AccordionTab>
            ...
            <div class="p-fluid">
              ...
              <p>
                Milliseid tehnilisi probleeme teil esines või mis jäi
                arusaamatuks?
              </p>
              ...
              <p>
                Kas eelistaksite antud keskkonda mõnele muule testikeskkonnale,
                näiteks Moodle? Kui ei, siis miks?
              </p>
      ...
      <template #footer>
        <div class="p-field-checkbox">
          ...
          <label for="binary"
            >Annan nõusoleku, et minu tagasisidet võib kasutada arendustöös ja
            reklaamilistel eesmärkidel. Korraldaja kohustus on tagada anonüümne
            tagasiside.</label
          >
        </div>
        <Button
          @click="submit"
          :disabled="!event.agreement"
          icon="pi pi-send"
          label="Esita tagasiside"
        />
      </template>
    </Card>
  </div>
